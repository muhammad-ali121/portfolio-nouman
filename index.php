...
<body class="theme-red">
  ...
  <div class="vg-page page-home" id="home" style="background-image: url(../assets/img/bg_image_1.jpg)">
    ...
    <div class="navbar navbar-expand-lg navbar-dark sticky" data-offset="500">
      <div class="container">
        <a href="" class="navbar-brand">N-Folio</a>
    ...
    <div class="caption-header text-center wow zoomInDown">
      ...
      <h1 class="fw-light mb-4">I'm <strong class="fg-theme" style="font-weight: 600;">Nouman</strong> Haider</h1>
      ...
      <div class="row">
        <div class="col-lg-4 py-3">
          <div class="img-place wow fadeInUp">
            <img src="assets/img/Nouman-profile.png" alt="">
          </div>
        </div>
        <div class="col-lg-6 offset-lg-1 wow fadeInRight">
          ...
          <ul class="theme-list">
            ...
            <li><b>Phone: </b><a href="tel:+92311392777" style="text-decoration: none;">+92 311 3932777</a></li>
            <li><b>Age:</b> 23</li>
            <!-- <li><b>Gender:</b> Male</li> -->
          </ul>
          <!-- <a class="btn btn-theme-outline" href="pdf/NoumanWeb.pdf" Download>Download CV</a> -->
        </div>
      </div>
    </div>
    <div class="container py-5">
      ...
      <div class="row py-3">
        <div class="col-md-6">
          <div class="px-lg-3">
            ...
            <div class="progress-wrapper wow fadeInUp">
              <span class="caption">WordPress, Wix & Shopify</span>
              <div class="progress">
        ...
        <div class="col-md-6">
          <div class="px-lg-3">
            ...
            <div class="progress-wrapper wow fadeInUp">
              <span class="caption">PHP (Laravel)</span>
              <div class="progress">
                <div class="progress-bar" role="progressbar" style="width: 65%;" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">65%</div>
              </div>
            </div>
            <div class="progress-wrapper wow fadeInUp">
              <span class="caption">SEO & Google Ads</span>
              <div class="progress">
                <div class="progress-bar" role="progressbar" style="width: 65%;" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">79%</div>
              </div>
            </div>
          </div>
        </div>
...
and websites for clients with WordPress, Wix, Shopfify, HTML, CSS, Bootstrap, and
JavaScript.</p>
              </div>
            </li>
            <li>
...
skills.</p>
  ...
  <!-- <div class="vg-page page-funfact" style="background-image: url(../assets/img/bg_banner.jpg);">
    <div class="container">
      <div class="row section-counter">
        ...
        <div class="col-md-6 col-lg-3 py-4 wow fadeIn">
          <h1 class="number" data-number="15">15+</h1>
  ...
  <div class="vg-page page-portfolio" id="portfolio">
    <div class="container">
      ...
      <div class="filterable-button py-3 wow fadeInUp" data-toggle="selected">
        ...
        <button class="btn btn-theme-outline" data-filter=".apps">Websites</button>
        <button class="btn btn-theme-outline" data-filter=".template">Landing Pages</button>
      ...
      <div class="gridder my-3">
        <div class="grid-item apps wow zoomIn">
          <div class="img-place" data-src="assets/img/work/goflare-gif.gif" data-fancybox data-caption="<h5 class='fg-theme'>Goflare</h5> <p>Digital Marketing Agency </p>">
            <img src="assets/img/work/goflare-page.jpg" alt="">
            <div class="img-caption">
              <h5 class="fg-theme">Goflare.com</h5>
              <p>Digital Marketing Agency</p>
            </div>
          </div>
          <br>
          <div class="text-center wow fadeInUp">
            <a href="https://goflare.com" target="_blank" class="btn btn-theme">Go Live</a>
          </div>
        </div>
       
        <div class="grid-item template wireframes wow zoomIn">
          <div class="img-place" data-src="assets/img/work/tiktok-gif.gif" data-fancybox data-caption="<h5 class='fg-theme'>Tiktok Advertising Agency</h5> <p>Social Media Marketing</p>">
            <img src="assets/img/work/tiktok-goflare.jpg" alt="">
            <div class="img-caption">
              <h5 class="fg-theme">Tiktok Advertising Agency</h5>
              <p>Social Media Marketing</p>
            </div>
          </div>
          <br>
          <div class="text-center wow fadeInUp">
            <a href="https://goflare.com/tiktok-advertising-agency" target="_blank" class="btn btn-theme">Go Live</a>
          </div>
        </div>
        <div class="grid-item apps ios wow zoomIn">
          <div class="img-place" data-src="assets/img/work/superior-gif.gif" data-fancybox data-caption="<h5 class='fg-theme'>Superior Trademarks</h5> <p>Business Trademarks</p>">
            <img src="assets/img/work/superiortrade.jpg" alt="">
            <div class="img-caption">
              <h5 class="fg-theme">Superior Trademarks</h5>
              <p>Business Trademarks </p>
            </div>
          </div>
          <br>
          <div class="text-center wow fadeInUp">
            <a href="https://superiortrademarks.com" target="_blank" class="btn btn-theme">Go Live</a>
          </div>
        </div>
        <div class="grid-item template wireframes wow zoomIn">
          <div class="img-place" data-src="assets/img/work/schools-gif.gif" data-fancybox data-caption="<h5 class='fg-theme'>Schools Marketing</h5> <p>Schools Digital Marketing</p>">
           <img src="assets/img/work/schools-goflare.jpg" alt="">
            <div class="img-caption">
              <h5 class="fg-theme">Schools Marketing</h5>
              <p>Schools Digital Marketing</p>
            </div>
          </div>
          <br>
          <div class="text-center wow fadeInUp">
            <a href="https://goflare.com/schools" target="_blank" class="btn btn-theme">Go Live</a>
          </div>
        </div>
        <div class="grid-item apps ios wow zoomIn">
          <div class="img-place" data-src="assets/img/work/bizflare-gif.gif" data-fancybox data-caption="<h5 class='fg-theme'>Bizflare Tech</h5> <p>Digital Tech Agency</p>">
            <img src="assets/img/work/bizflare-tech.jpg" alt="">
            <div class="img-caption">
              <h5 class="fg-theme">Bizflare Tech</h5>
              <p>Digital Tech Agency</p>
            </div>
          </div>
          <br>
          <div class="text-center wow fadeInUp">
            <a href="https://bizflaretech.com" target="_blank" class="btn btn-theme">Go Live</a>
          </div>
        </div>
        <div class="grid-item apps graphic ui-ux wireframes wow zoomIn">
          ...
          <br>
          <div class="text-center wow fadeInUp">
            <a href="https://www.apex-consultant.com" target="_blank" class="btn btn-theme">Go Live</a>
          </div>
        </div>
        <div class="grid-item apps wireframes wow zoomIn">
          <div class="img-place" data-src="assets/img/work/discountsflare.png" data-fancybox data-caption="<h5 class='fg-theme'>Discount Flare</h5> <p>Affiliate Marketing</p>">
           <img src="assets/img/work/discountsflare.png" alt="">
            <div class="img-caption">
              <h5 class="fg-theme">Discounts Flare</h5>
              <p>Affiliate Marketing</p>
            </div>
          </div>
          <br>
          <div class="text-center wow fadeInUp">
            <a href="https://discountsflare.com" target="_blank" class="btn btn-theme">Go Live</a>
          </div>
        </div>
        <div class="grid-item apps ios wow zoomIn">
          <div class="img-place" data-src="assets/img/work/sahaili.png" data-fancybox data-caption="<h5 class='fg-theme'>Sahaili</h5> <p>E-Commerce Clothing Store</p>">
            <img src="assets/img/work/sahaili.png" alt="">
            <div class="img-caption">
              <h5 class="fg-theme">Sahaili</h5>
              <p>E-Commerce Clothing Store</p>
            </div>
          </div>
          <br>
          <div class="text-center wow fadeInUp">
            <a href="https://www.sahaili.com" target="_blank" class="btn btn-theme">Go Live</a>
          </div>
        </div>
        <div class="grid-item apps graphic ui-ux wireframes wow zoomIn">
          <div class="img-place" data-src="assets/img/work/bhojpatra.png" data-fancybox data-caption="<h5 class='fg-theme'>Bhojpatra Wellness</h5> <p>Organic Treatment E-Commerce</p>">
            <img src="assets/img/work/bhojpatra.png" alt="">
            <div class="img-caption">
              <h5 class="fg-theme">Bhojpatra Wellness</h5>
              <p>Organic Treatment E-Commerce</p>
            </div>
          </div>
          <br>
          <div class="text-center wow fadeInUp">
            <a href="https://bhojpatra1.myshopify.com/" target="_blank" class="btn btn-theme">Go Live</a>
          </div>
        </div>
        <div class="grid-item apps wireframes wow zoomIn">
          <div class="img-place" data-src="assets/img/work/newshiggs.png" data-fancybox data-caption="<h5 class='fg-theme'>Newshiggs</h5> <p>Auto News Website</p>">
           <img src="assets/img/work/newshiggs.png" alt="">
            <div class="img-caption">
              <h5 class="fg-theme">Newshiggs</h5>
              <p>Auto News Website</p>
            </div>
          </div>
          <br>
          <div class="text-center wow fadeInUp">
            <a href="https://newshiggs.com" target="_blank" class="btn btn-theme">Go Live</a>
          </div>
        </div>
        <div class="grid-item apps ios wow zoomIn">
          <div class="img-place" data-src="assets/img/work/pethiggs.png" data-fancybox data-caption="<h5 class='fg-theme'>Pethiggs</h5> <p>Pets News & Updates</p>">
            <img src="assets/img/work/pethiggs.png" alt="">
            <div class="img-caption">
              <h5 class="fg-theme">Pethiggs</h5>
              <p>Pets News & Updates</p>
            </div>
          </div>
          <br>
          <div class="text-center wow fadeInUp">
            <a href="https://pethiggs.com" target="_blank" class="btn btn-theme">Go Live</a>
          </div>
        </div>
        <div class="grid-item apps graphic ui-ux wireframes wow zoomIn">
          <div class="img-place" data-src="assets/img/work/sisdubai.png" data-fancybox data-caption="<h5 class='fg-theme'>SIS School Dubai</h5> <p>International School Dubai</p>">
            <img src="assets/img/work/sisdubai.png" alt="">
            <div class="img-caption">
              <h5 class="fg-theme">SIS School Dubai</h5>
              <p>International School Dubai</p>
            </div>
          </div>
          <br>
          <div class="text-center wow fadeInUp">
            <a href="https://www.sisdubai.com/" target="_blank" class="btn btn-theme">Go Live</a>
          </div>
        </div>
        <div class="grid-item apps wireframes wow zoomIn">
          <div class="img-place" data-src="assets/img/work/tikkafusion.png" data-fancybox data-caption="<h5 class='fg-theme'>Tikka Fusion</h5> <p>Resturant Website</p>">
           <img src="assets/img/work/tikkafusion.png" alt="">
            <div class="img-caption">
              <h5 class="fg-theme">Tikka Fusion</h5>
              <p>Resturant Website</p>
            </div>
          </div>
          <br>
          <div class="text-center wow fadeInUp">
            <a href="https://tikkafusion.ca" target="_blank" class="btn btn-theme">Go Live</a>
          </div>
        </div>
        <div class="grid-item apps wireframes wow zoomIn">
          <div class="img-place" data-src="assets/img/work/blinklashclub.png" data-fancybox data-caption="<h5 class='fg-theme'>Blink Lash Club</h5> <p>Beauty Salon Services</p>">
           <img src="assets/img/work/blinklashclub.png" alt="">
            <div class="img-caption">
              <h5 class="fg-theme">Blink Lash Club</h5>
              <p>Beauty Salon Services</p>
            </div>
          </div>
          <br>
          <div class="text-center wow fadeInUp">
            <a href="https://blinklashclub.com" target="_blank" class="btn btn-theme">Go Live</a>
          </div>
        </div>
  ...
  <div class="vg-page page-testimonial">
    <div class="container">
      <h1 class="text-center fw-normal wow fadeInUp">Testimonials</h1>
          ...
          <div class="owl-carousel testi-carousel">
            <div class="item">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="caption">
                    <div class="testi-content">Thanks to Nouman, our online store is thriving. Their skills in Shopify and WooCommerce are unmatched. Our e-commerce website not only looks fantastic but functions seamlessly, making the shopping experience a breeze for our customers. We're grateful...</div>
            ...
            <div class="item">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="caption">
                    <div class="testi-content">Working with Nouman has been an absolute pleasure. His  expertise in WordPress, Wix, and Shopify web development is truly commendable. He transformed our outdated websites into a modern, user-friendly masterpiece. We are thrilled with the results!</div>
                    <div class="testi-info">
                      <div class="thumb-profile">
                        <img src="../assets/img/testimonials/testimonials_2.jpg" alt="">
                      </div>
                      <div class="tagline">
                        <h5 class="mb-0">Muzammil Hussain</h5>
          ...
          <form class="vg-contact-form" method="POST" action="success.php">
            <div class="form-row">
              ...
              <div class="col-6 mt-3 wow fadeInUp">
                <input class="form-control" type="text" name="your_email" placeholder="Email Address">
              </div>
              <div class="col-6 mt-3 wow fadeInUp">
  ...
  <div class="vg-footer">
    ...
    <div class="container">
      <div class="row">
        <!-- <div class="col-lg-4 py-3">
          <div class="footer-info">
            ...
            <hr class="divider">
            <p class="fs-large fg-white">Azeem Road Kala Gujran Jhelum, Pakistan</p>
          </div>
        </div> -->
      ...
      <div class="row justify-content-center mt-3">
        ...
        <div class="col-12">
          <p class="text-center mb-0 mt-4">Copyright &copy;2022. All right reserved by <a href="#">Nouman Haider</a></p>
        </div>
      </div>
    </div>
  </div> <!-- End footer -->
